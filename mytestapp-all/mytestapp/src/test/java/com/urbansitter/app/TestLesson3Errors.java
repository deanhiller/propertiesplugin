...
import com.urbansitter.app.mock.JavaCache;
import com.urbansitter.app.mock.MockRemoteService;
import com.urbansitter.app.mock.MockSomeLibrary;
import com.urbansitter.app.service.FetchValueResponse;
...
public class TestLesson3Errors extends AbstractWebpiecesTest {
	...
	private String[] args = { "-http.port=:0", "-https.port=:0", "-hibernate.persistenceunit=com.urbansitter.app.db.DbSettingsInMemory", "-hibernate.loadclassmeta=true" };
