...
public class MyHtmlTagCreator implements HtmlTagCreator {
	...
	public List<Tag> createTags() {
		...
		tags.add(new CustomTag("/com/urbansitter/app/web/tags/mytag.tag"));
		tags.add(new IdTag(converter, "/com/urbansitter/app/web/tags/id.tag"));
		
		//you can also override(subclass or whatever) any tag by replacing it in the map
		//This replaces the field tag
		//put(new FieldTag(converter, "/com/urbansitter/app/base/tags/field.tag"));
