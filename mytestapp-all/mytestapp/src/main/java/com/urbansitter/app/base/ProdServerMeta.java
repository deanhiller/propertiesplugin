...
import com.urbansitter.app.basesvr.YourGlobalModule;
import com.urbansitter.app.json.*;
import com.urbansitter.app.web.login.LoginRoutes;
import com.urbansitter.app.web.main.MainRoutes;
import com.urbansitter.app.web.secure.crud.CrudRoutes;
import com.urbansitter.app.web.secure.crudajax.AjaxCrudRoutes;
...
public class ProdServerMeta implements WebAppMeta {
    ...
    public List<Routes> getRouteModules() {
		return Lists.newArrayList(
				...
				new MainRoutes(),
				//The Controller package regex is com.urbansitter.app.web.secure\..* so that we match com.urbansitter.app.web.secure.* Controllers 
				new LoginRoutes("/com/urbansitter/app/web/login/AppLoginController", "com.urbansitter.app.web.secure\\..*", "password"),
				new CrudRoutes(),
				new AjaxCrudRoutes(),
				new JsonRoutes()
				);
	...
	public List<Plugin> getPlugins() {
		...
		return Lists.newArrayList(
				...
				new JacksonPlugin(new JacksonConfig().setPackageFilterPattern("com.urbansitter.app.json.*")),
